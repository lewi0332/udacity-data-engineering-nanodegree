...
create_lifetime_riders_task = PostgresOperator(
    task_id='create_lifetime_riders_task',
    dag=dag,
    sql="""
        BEGIN;
...
create_city_stations_counts_task = PostgresOperator(
    task_id='create_city_stations_counts_task',
    dag=dag,
    sql="""
        BEGIN;
...
create_lifetime_riders_task
create_city_stations_counts_task
